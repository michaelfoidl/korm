...
internal class ForeignKeyEntityBuilder internal constructor(
        propertyName: String,
    ...
    override fun getReferencedTable(tables: Collection<Table>): Table? {
        return tables.find { it.name == TableEntityBuilder(this.foreignKeyAnnotation!!.referencedClass).getName() }
    }
